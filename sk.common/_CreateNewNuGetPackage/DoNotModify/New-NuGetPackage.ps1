...
$NUGET_EXE_SUCCESSFULLY_CREATED_PACKAGE_MESSAGE_REGEX = [regex] '(?i)(Pomyślnie utworzono pakiet "(?<FilePath>.*?)".)'
$NUGET_EXE_SUCCESSFULLY_PUSHED_PACKAGE_MESSAGE = 'Pakiet został wypchnięty.'
